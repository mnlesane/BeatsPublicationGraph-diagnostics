...
export class PublishingLogic extends ethereum.SmartContract {
  static bind(address: Address): PublishingLogic {
    return new PublishingLogic("PublishingLogic", address);
  }
}
